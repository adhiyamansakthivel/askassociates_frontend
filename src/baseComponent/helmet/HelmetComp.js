...
export default function HelmetComp({title, data}) {
    ...
    const imageUrl = data?.imgUrl ? data?.imagUrl : "https://askassociatescbe.com/assets/img/askassociates_logo.png"

    return (
        <Helmet>
            <title>{siteTitle} | Ask Associates Coimbatore & Palladam | askassociatescbe.com</title>
            <meta name="title" content="Ask Associates Coimbatore & Palladam | askassociatescbe.com"  />
